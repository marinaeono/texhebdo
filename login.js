...
const startVideo = "videochevre/start.mp4";
const successVideo = "videochevre/success2.mp4";

const errorVideos = [
  "videochevre/error1.mp4",
  "videochevre/error2.mp4",
  "videochevre/error3.mp4",
  "videochevre/error4.mp4",
  "videochevre/error5.mp4"
];
...
if (input === goodPassword) {
  ...
  // Redirection quand la vidéo est terminée
  goatVideo.onended = () => {
